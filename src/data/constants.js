export const Bio = {
  ...
  roles: [
    ...
    "Ex-(React) Intern, IMMWIT Pvt Ltd",
  ],
  description:
    "I have 2 years of experience in web development since i have started web dev from 2nd year , I have also work experience in startup Affworld Technologies (Frontend) handle admin panel and advitisor panel of website and also handle AWS server for deployment , I am familiar with React Js , React Native , Nodejs , Mongodb. All my projects are available at laxmikant.co",
  github: "https://github.com/laxmikant007",
  resume:
    "https://drive.google.com/file/d/1VjuP9CSuYqxhShfxjxmHowdYR0EScmfX/view?usp=drive_link",
